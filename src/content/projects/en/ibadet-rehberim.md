...
Everything a person needs for daily worship, gathered into one calm interface:

- **Prayer times** — for your location, using the calculation method of the
  Turkish Directorate of Religious Affairs.
- **Prayer time notifications** — exactly on time. They work even when the
  phone is offline.
- **Smart dhikr counter** — ready-made dhikr sets or your own, with daily goal
  tracking.
- **Islamic assistant** — an AI-powered chat where you can ask the religious
  questions on your mind.
- **Daily prayer, hadith and verse** — a short feed that refreshes every day.
  Each post states the source the text comes from, so you can see what you are
  reading is based on.
- **Records that survive a new phone** — sign in and your dhikr progress is
  backed up, so you pick up where you left off on your next device.

The app is free. For those who would rather not see ads there is a weekly or
